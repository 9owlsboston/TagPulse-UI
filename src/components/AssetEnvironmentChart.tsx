...
// the journey, with transit-leg boundaries as vertical guides and breached legs
// shaded red. Selecting a leg highlights its window. (The exact SLA threshold
// band is a follow-up once tenant SLA is exposed; v1 shades breached legs from
// the leg's computed `sla_breached`.)
...
import { useAssetLegs, useAssetStateHistory } from '@/hooks/useAssets';
